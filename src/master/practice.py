...
class FindBag(smach.State):
    ...
    def execute(self, userdata):
        tts_srv('/cml/which_bag')#"Here you are"
        ...
        while not rospy.is_shutdown():
            ...
            if self.pose_msg == 'left':
                ...
                tts_srv('/cml/find_bag') #"I found a bag."
                self.base_control.rotateAngle(-find_angle)
                userdata.find_angle_out = find_angle
                tts_srv('/cml/bag_left')#The bag on the left from you, please give it to me."
                return 'find_success'
                ...
                self.base_control.rotateAngle(find_angle)
                userdata.find_angle_out = -find_angle
                tts_srv('/cml/bag_right')#"The bag on the right from you, please give it to me."
                return 'find_success'
            else:
                pass
...
class GraspOrPass(smach.State):
    ...
    def execute(self, userdata):
        ...
        if userdata.GOP_count_in == 0:
            ...
            tts_srv('/cml/pass_thank')#"Thank you."
            self.arm_srv('carry')
            return 'GRASP_finish'
            #if result:
                #tts_srv('Thank You')
            ...
            tts_srv('/cml/give_bag')#"Here you are."
            self.arm_srv('give')
            self.head_pub.publish(0)
...
class Chaser(smach.State):
    ...
    def execute(self, userdata):
        ...
        tts_srv("/cml/follow_you")#"I'll follow you."
        ...
        while not rospy.is_shutdown():
            ...
            if self.cmd_sub == 0.0 and self.find_msg == 'NULL':
                ...
                tts_srv("/cml/car_question")#"Is this the location of the car?"
                ...
                if answer:
                    ...
                    tts_srv("cml/follow_cont")#"Ok, continue to follow."
            elif self.find_msg == "lost":
                self.start_time = time.time()
                self.find_msg = 'lost_after'
            elif self.find_msg == "lost_after" and now_time >= 1.0:
                tts_srv("/cml/follow_lost")#"I lost sight of you. Wait for me please."
...
class Return(smach.State):
    ...
    def execute(self, userdata):
        ...
        rospy.sleep(0.5)
        tts_srv("/cml/finish_cml")#"Finish carry my luggage. Thank you very much."
